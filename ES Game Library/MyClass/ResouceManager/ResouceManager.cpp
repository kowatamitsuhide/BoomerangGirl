...
SPRITE ResouceManager::LoadSpriteFile(tstring sprite_file_name)
{
...
FONT ResouceManager::LoadFontFile(tstring font_file_name, float size)
{
...
EFFECT ResouceManager::LoadEffectFile(tstring effect_file_name)
{
...
SOUND ResouceManager::LoadSoundFile(tstring sound_file_name)
{
...
MUSIC ResouceManager::LoadMusicFile(tstring music_file_name)
{
...
MEDIA ResouceManager::LoadMediaFile(tstring media_file_name)
{
...
EFFEKSEER ResouceManager::LoadEffekseerFile(tstring effekseer_file_name)
{
